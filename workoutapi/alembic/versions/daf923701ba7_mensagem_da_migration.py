"""mensagem_da_migration

Revision ID: daf923701ba7
Revises: 
Create Date: 2025-08-12 12:59:29.654689
...
def upgrade() -> None:
    ...
    sa.Column('categoria_id', sa.Integer(), nullable=False, foreign_key='categorias.pk_id'),
    sa.Column('centro_treinamento_id', sa.Integer(), nullable=False, foreign_key='centros_treinamento.pk_id'),
